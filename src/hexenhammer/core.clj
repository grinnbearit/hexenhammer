...
(defroutes api-handler
  ...
  (GET "/favicon.ico" [] "")
  (GET "/react/:reaction" [reaction] (swap! hexenhammer-state controller/react-transition (keyword reaction)))
  ...
  (POST "/react/hold" [] (swap! hexenhammer-state controller/react-hold))
  (POST "/react/flee" [] (swap! hexenhammer-state controller/react-flee))
  (POST "/react/trigger" [] (swap! hexenhammer-state controller/react-trigger))
